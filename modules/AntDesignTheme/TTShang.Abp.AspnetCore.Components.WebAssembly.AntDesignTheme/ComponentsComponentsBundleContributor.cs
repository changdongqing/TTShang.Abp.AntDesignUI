...
namespace TTShang.Abp.AspnetCore.Components.WebAssembly.AntDesignTheme;
...
public class ComponentsComponentsBundleContributor : IBundleContributor
{
    ...
    public void AddStyles(BundleContext context)
    {
        ...
        context.Add("_content/TTShang.Abp.AspnetCore.Components.Web.AntDesignTheme/libs/abp/css/theme.css");
    }
}
